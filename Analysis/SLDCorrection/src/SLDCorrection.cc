...
void SLDCorrection::init()
{
	...
	if ( m_fillRootTree )
	{
		...
		m_pTTree1->Branch( "recoPVARecoFourMomentum_minus_truePVARecoNeutralFourMomentum_Px" , &m_recoPVARecoFourMomentum_minus_truePVARecoNeutralFourMomentum_Px );
		m_pTTree1->Branch( "recoPVARecoFourMomentum_minus_truePVARecoNeutralFourMomentum_Py" , &m_recoPVARecoFourMomentum_minus_truePVARecoNeutralFourMomentum_Py );
		m_pTTree1->Branch( "recoPVARecoFourMomentum_minus_truePVARecoNeutralFourMomentum_Pz" , &m_recoPVARecoFourMomentum_minus_truePVARecoNeutralFourMomentum_Pz );
		m_pTTree1->Branch( "recoPVARecoFourMomentum_minus_truePVARecoNeutralFourMomentum_E" , &m_recoPVARecoFourMomentum_minus_truePVARecoNeutralFourMomentum_E );
		m_pTTree1->Branch( "recoPVARecoFourMomentum_minus_truePVARecoNeutralFourMomentum_M" , &m_recoPVARecoFourMomentum_minus_truePVARecoNeutralFourMomentum_M );
		m_pTTree1->Branch( "recoPVARecoFourMomentum_minus_truePVARecoChargedFourMomentum_Px" , &m_recoPVARecoFourMomentum_minus_truePVARecoChargedFourMomentum_Px );
		m_pTTree1->Branch( "recoPVARecoFourMomentum_minus_truePVARecoChargedFourMomentum_Py" , &m_recoPVARecoFourMomentum_minus_truePVARecoChargedFourMomentum_Py );
		m_pTTree1->Branch( "recoPVARecoFourMomentum_minus_truePVARecoChargedFourMomentum_Pz" , &m_recoPVARecoFourMomentum_minus_truePVARecoChargedFourMomentum_Pz );
		m_pTTree1->Branch( "recoPVARecoFourMomentum_minus_truePVARecoChargedFourMomentum_E" , &m_recoPVARecoFourMomentum_minus_truePVARecoChargedFourMomentum_E );
		m_pTTree1->Branch( "recoPVARecoFourMomentum_minus_truePVARecoChargedFourMomentum_M" , &m_recoPVARecoFourMomentum_minus_truePVARecoChargedFourMomentum_M );
		...
		m_pTTree1->Branch( "Alpha_RecoPVARecoAll_minus_TruePVARecoCharged_vs_recoPVArecoNeutral" , &m_Alpha_RecoPVARecoAll_minus_TruePVARecoCharged_vs_recoPVArecoNeutral );
		m_pTTree1->Branch( "SinAlpha_RecoPVARecoAll_minus_TruePVARecoCharged_vs_recoPVArecoNeutral" , &m_SinAlpha_RecoPVARecoAll_minus_TruePVARecoCharged_vs_recoPVArecoNeutral );
		m_pTTree1->Branch( "CosAlpha_RecoPVARecoAll_minus_TruePVARecoCharged_vs_recoPVArecoNeutral" , &m_CosAlpha_RecoPVARecoAll_minus_TruePVARecoCharged_vs_recoPVArecoNeutral );
		m_pTTree1->Branch( "Alpha_RecoPVARecoAll_minus_TruePVARecoNeutral_vs_recoPVArecoCharged" , &m_Alpha_RecoPVARecoAll_minus_TruePVARecoNeutral_vs_recoPVArecoCharged );
		m_pTTree1->Branch( "SinAlpha_RecoPVARecoAll_minus_TruePVARecoNeutral_vs_recoPVArecoCharged" , &m_SinAlpha_RecoPVARecoAll_minus_TruePVARecoNeutral_vs_recoPVArecoCharged );
		m_pTTree1->Branch( "CosAlpha_RecoPVARecoAll_minus_TruePVARecoNeutral_vs_recoPVArecoCharged" , &m_CosAlpha_RecoPVARecoAll_minus_TruePVARecoNeutral_vs_recoPVArecoCharged );
		...
		h_NuPxResidual = new TH1F( "PxResidual" , "; _{}p_{x,#nu}^{REC} - p_{x,#nu}^{MC} [GeV]; Normalized #SLDs / 0.1 GeV" , 200 , -10.0 , 10.0 );
		h_NuPyResidual = new TH1F( "PyResidual" , "; _{}p_{y,#nu}^{REC} - p_{y,#nu}^{MC} [GeV]; Normalized #SLDs / 0.1 GeV" , 200 , -10.0 , 10.0 );
		h_NuPzResidual = new TH1F( "PzResidual" , "; _{}p_{z,#nu}^{REC} - p_{z,#nu}^{MC}  [GeV]; Normalized #SLDs / 0.1 GeV" , 200 , -10.0 , 10.0 );
		h_NuEResidual = new TH1F( "EResidual" , "; _{}E_{#nu}^{REC} - E_{#nu}^{MC} [GeV]; Normalized #SLDs / 0.1 GeV" , 200 , -10.0 , 10.0 );
		h_NuPxNormalizedResidual = new TH1F( "PxNormalizedResidual" , "; ( _{}p_{x,#nu}^{REC} - p_{x,#nu}^{MC} ) / #sigma_{p_{x,#nu}}; Normalized #SLDs / 0.1" , 200 , -10.0 , 10.0 );
		h_NuPyNormalizedResidual = new TH1F( "PyNormalizedResidual" , "; ( _{}p_{y,#nu}^{REC} - p_{y,#nu}^{MC} ) / #sigma_{p_{y,#nu}}; Normalized #SLDs / 0.1" , 200 , -10.0 , 10.0 );
		h_NuPzNormalizedResidual = new TH1F( "PzNormalizedResidual" , "; ( _{}p_{z,#nu}^{REC} - p_{z,#nu}^{MC} ) / #sigma_{p_{z,#nu}}; Normalized #SLDs / 0.1" , 200 , -10.0 , 10.0 );
		h_NuENormalizedResidual = new TH1F( "ENormalizedResidual" , "; ( _{}E_{#nu}^{REC} - E_{#nu}^{MC} ) / #sigma_{E_{#nu}}; Normalized #SLDs / 0.1" , 200 , -10.0 , 10.0 ); 
...
void SLDCorrection::processRunHeader( LCRunHeader* )
{
	m_nRun = 0;
	m_nEvt = 0;
	++m_nRunSum;
...
////////////////////////////////////////////////////////////////////////////////
	...
	evaluateInputCovMat( truePVATrueFourMomentum , trueFlightDirection , trueNeutrinoFourMomentum , visibleFourMomentum , flightDirection , recoNeutrinoFourMomentumClose , CovMatrixDetector , NeutrinoCovMat );
...
void SLDCorrection::addNeutrinoCovarianceMatrix( const TLorentzVector &neutrinoFourMomentum , std::vector< float > &NuCovMat )
{
...
TLorentzVector SLDCorrection::getNeutrinoFourMomentum( const TVector3 &flightDirection , const TLorentzVector &visibleFourMomentum , const double &ParentHadronMass , const float &solutionSign )
{
...
TLorentzVector SLDCorrection::getNeutrinoFourMomentumModified( TVector3 &flightDirection , const TLorentzVector &visibleFourMomentum , const double &ParentHadronMass , const float &solutionSign )
{
	int sign = ( solutionSign != 0 ? solutionSign / abs( solutionSign ) : 1 );
	m_solutionSign.push_back( sign );
	const char *solSign = ( sign >= 0 ? "+" : "-" );
...
TLorentzVector SLDCorrection::getNeutrinoFourMomentumStandardMethod( const TVector3 &flightDirection , const TLorentzVector &visibleFourMomentum , const double &parentHadronMass , const float &solutionSign )
{
	int sign = ( solutionSign != 0 ? solutionSign / abs( solutionSign ) : 1 );
	m_solutionSign.push_back( sign );
	const char *solSign = ( sign >= 0 ? "+" : "-" );
...
void SLDCorrection::plotHistograms( const TLorentzVector &trueFourMomentumNeutrino , const TLorentzVector &FourMomentumNuClose , const FloatVector &NeutrinoCovMat )
{
