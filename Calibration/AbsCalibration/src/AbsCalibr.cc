...
void AbsCalibr::init() {
  //============================================================================
  std::cout << "AbsCalibr::init()  " << name() << std::endl << "  parameters: " << std::endl << *parameters();
  ...
  std::cout << "++++++++++++++ HBOOK and HPLOT were initiaslized +++++++++++++++++++ " << std::endl;
//         +++++++++++++ HBOOK +++  HPLOT  ++++++++++++++++
#endif
...
void AbsCalibr::processRunHeader(LCRunHeader* run) {
  //============================================================================
  std::cout << "AbsCalibr::processRun()  " << name() << " in run " << run->getRunNumber() << "; description is "
...
void AbsCalibr::end() {
  //============================================================================
  std::cout << "AbsCalibr::end()  " << name() << " processed " << _nEvt << " events in " << _nRun << " runs "
            << std::endl;
#ifdef USE_HBOOK
