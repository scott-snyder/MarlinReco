...
SimDigitalLinkToParticles::SimDigitalLinkToParticles()
	: Processor("SimDigitalLinkToParticles")
{
	...
	registerInputCollections( LCIO::LCCOLLECTION ,
...
{
	assert ( _inputCollections.size() == _inputRelCollections.size() && _inputCollections.size() == _outputRelCollections.size() ) ;
}
