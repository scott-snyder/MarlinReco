...
/**
 *    Initial version of a processor to find electro-magnetic showers. It is based on the KIT package and takes only
 * ECAL hits into account. The output is a collection of clusters in which the electro-magnetic showers are stored. More
 * docu will come soon. <br>
 *
 *    @author O. Wendt (DESY)
 *    @version
 *
